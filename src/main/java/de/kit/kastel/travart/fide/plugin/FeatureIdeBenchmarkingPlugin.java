...
@Extension
public class FeatureIdeBenchmarkingPlugin implements IBenchmarkingPlugin<FeatureModel> {

	public static final String ID = "fide-benchmarking-plugin";
	...
	@Override
	public AbstractBenchmarkingTransformer<FeatureModel> getBenchmarkingTransformer() {
		return new FeatureIdeModelTransformer();
	}
}
